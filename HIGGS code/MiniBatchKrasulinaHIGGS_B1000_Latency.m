function [u] = MiniBatchOjaHIGGS_Final_B1000_Latency
...
gamma = 6000;
Latency = [0, 10, 100, 1000, 5000, 1e4];
...
for simulationRun=1:TotalSimulationRuns
    ...
    %% Saving results
    tic
    save -v7.3 ErrorKrasulinaMiniBatch_Final_B_1000_Latency ErrorMiniBatchOja TotalConvergingRuns
    toc
end
end