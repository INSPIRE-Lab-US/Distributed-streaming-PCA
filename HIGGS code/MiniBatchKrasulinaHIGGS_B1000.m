function [u] = MiniBatchOjaHIGGS_Final_B1000
...
for simulationRun=1:TotalSimulationRuns
    ...
    %% Saving results
    tic
    save -v7.3 Results\ErrorKrasulinaMiniBatch_Final_B_1000 ErrorMiniBatchOja TotalConvergingRuns
    toc
end
end