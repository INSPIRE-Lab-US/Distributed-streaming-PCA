function [u] = MiniBatchOjaSynthetic_Final_B1000_gap0_4
...
A = diag([1 0.4 0.3 0.2 0.1]); % Gap = 0.2
ER = A*ER;
a = mean(ER, 2);
...
for simulationRun=1:TotalSimulationRuns
    ...
    %% Saving results
    tic
    save -v7.3 ErrorKrasulinaMiniBatch_Final_B_1000_gap_0_4 ErrorMiniBatchOja TotalConvergingRuns
    toc
end
end