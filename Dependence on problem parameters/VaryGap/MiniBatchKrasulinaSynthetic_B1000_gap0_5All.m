function [u] = MiniBatchOjaSynthetic_Final_B1000_gap0_5All
...
A = diag([1 0.5 0.4 0.3 0.2]); % Gap = 0.2
ER = A*ER;
a = mean(ER, 2);
...
%% Saving results
    tic
    save -v7.3 ErrorKrasulinaMiniBatch_Final_B_1000_gap_0_5 ErrorMiniBatchOja TotalConvergingRuns
    toc
end