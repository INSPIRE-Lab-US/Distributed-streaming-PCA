function [u] = MiniBatchOjaSynthetic_Final_B1_r100
...
for simulationRun=1:TotalSimulationRuns
    ...
    %% Saving results
    tic
    save -v7.3 ErrorKrasulinaMiniBatch_Final_B_1_r100 ErrorMiniBatchOja TotalConvergingRuns maxNorm
    toc
end
end