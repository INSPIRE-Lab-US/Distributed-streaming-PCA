function [u] = MiniBatchOjaSynthetic_Final_B2000
...
for simulationRun=1:TotalSimulationRuns
    ...
    %% Saving results
    tic
    save -v7.3 Results\ErrorKrasulinaMiniBatch_Final_B_2000 ErrorMiniBatchOja TotalConvergingRuns
    toc
end
end